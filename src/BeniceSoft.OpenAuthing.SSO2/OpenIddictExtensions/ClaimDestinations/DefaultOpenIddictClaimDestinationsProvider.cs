...
public class DefaultOpenIddictClaimDestinationsProvider : IOpenIddictClaimDestinationsProvider, ITransientDependency
{
    public virtual Task SetDestinationsAsync(OpenIddictClaimDestinationsProviderContext context)
    {
