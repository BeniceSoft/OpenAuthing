...
public class AuthingDingTalkClient : IAuthingDingTalkClient, ITransientDependency
{
    private const string AccessTokenCacheKey = "am:dingtalk:access_token";

    private readonly DingTalkOptions _options;
    private readonly ILogger<AuthingDingTalkClient> _logger;
    private readonly AlibabaCloud.OpenApiClient.Models.Config _config;

    public AuthingDingTalkClient(IOptions<DingTalkOptions> options,
        ILogger<AuthingDingTalkClient> logger,
