...
namespace BeniceSoft.OpenAuthing.OpenIddict.Authorizations;

public class AmOpenIddictAuthorizationStore : AmOpenIddictStoreBase<IOpenIddictAuthorizationRepository>,
    IOpenIddictAuthorizationStore<OpenIddictAuthorizationModel>
{
    ...
    public AmOpenIddictAuthorizationStore(
    ...
    public virtual ValueTask<long> CountAsync<TResult>(Func<IQueryable<OpenIddictAuthorizationModel>, IQueryable<TResult>> query,
    ...
    public virtual async IAsyncEnumerable<OpenIddictAuthorizationModel> FindAsync(string subject, string client, string status,
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        Check.NotNullOrEmpty(subject, nameof(subject));
        Check.NotNullOrEmpty(client, nameof(client));
    ...
    public virtual async IAsyncEnumerable<OpenIddictAuthorizationModel> FindAsync(string subject, string client, string status, string type,
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        Check.NotNullOrEmpty(subject, nameof(subject));
        Check.NotNullOrEmpty(client, nameof(client));
    ...
    public virtual ValueTask<TResult> GetAsync<TState, TResult>(Func<IQueryable<OpenIddictAuthorizationModel>, TState, IQueryable<TResult>> query,
    ...
    public virtual ValueTask<ImmutableDictionary<string, JsonElement>> GetPropertiesAsync(OpenIddictAuthorizationModel authorization,
        CancellationToken cancellationToken)
    {
        Check.NotNull(authorization, nameof(authorization));
    ...
    public virtual IAsyncEnumerable<TResult> ListAsync<TState, TResult>(
        Func<IQueryable<OpenIddictAuthorizationModel>, TState, IQueryable<TResult>> query, TState state, CancellationToken cancellationToken)
    {
        throw new NotSupportedException();
    }
    ...
    public virtual async ValueTask SetApplicationIdAsync(OpenIddictAuthorizationModel authorization, string identifier,
        CancellationToken cancellationToken)
    {
        Check.NotNull(authorization, nameof(authorization));
    ...
    public virtual ValueTask SetPropertiesAsync(OpenIddictAuthorizationModel authorization, ImmutableDictionary<string, JsonElement> properties,
        CancellationToken cancellationToken)
    {
    ...
    public virtual ValueTask SetScopesAsync(OpenIddictAuthorizationModel authorization, ImmutableArray<string> scopes,
        CancellationToken cancellationToken)
    {
        Check.NotNull(authorization, nameof(authorization));
