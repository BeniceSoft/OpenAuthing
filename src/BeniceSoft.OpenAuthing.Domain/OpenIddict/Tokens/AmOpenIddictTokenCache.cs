...
public class AmOpenIddictTokenCache : AmOpenIddictCacheBase<OpenIddictToken, OpenIddictTokenModel, IOpenIddictTokenStore<OpenIddictTokenModel>>,
    IOpenIddictTokenCache<OpenIddictTokenModel>,
    ITransientDependency
{
    public AmOpenIddictTokenCache(
